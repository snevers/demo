...
import com.tgj.config.RedisConfig;

public class RedisUtils {
	final static StringRedisTemplate stringRedisTemplate = RedisConfig.getBean("stringRedisTemplate",
			StringRedisTemplate.class);
	@SuppressWarnings("unchecked")
	final static RedisTemplate<String, Object> redisTemplate = RedisConfig.getBean("redisTemplate",
			RedisTemplate.class);
	...
	public static void sadd(String key, String... value) {
		redisTemplate.boundSetOps(key).add((Object[]) value);
	}
	...
	public static void srem(String key, String... value) {
		redisTemplate.boundSetOps(key).remove((Object[]) value);
	}
